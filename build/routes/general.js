...
const callRecording_1 = require("../controllers/callRecording");
const switchRole_1 = require("../controllers/switchRole");
...
routes.get('/accounts/banks', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.getBanks);
routes.post('/accounts', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.addAccount);
routes.get('/accounts', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.getAccounts);
routes.post('/accounts/resolve', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.resolveAccount);
routes.put('/accounts/:recipientCode', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.updateAccount);
routes.delete('/accounts/:recipientCode', (0, allowRoles_1.allowRoles)(enum_1.UserRole.PROFESSIONAL, enum_1.UserRole.CLIENT, enum_1.UserRole.DELIVERY), account_1.deleteAccount);
...
routes.post('/debit-wallet', rateLimiter_1.paymentLimiter, /*allowRoles(UserRole.SEEKER),*/ wallet_1.debitWallet);
routes.post('/debit-wallet/product', rateLimiter_1.paymentLimiter, /*allowRoles(UserRole.SEEKER),*/ wallet_1.debitWalletForProductOrder);
routes.post('/credit-wallet', rateLimiter_1.paymentLimiter, /*allowRoles(UserRole.SEEKER),*/ wallet_1.creditWallet);
...
routes.post('/payments/initiate', rateLimiter_1.paymentLimiter, /*allowRoles(UserRole.SEEKER),*/ payment_1.initiatePayment);
routes.post('/payments/verify/:ref', /*allowRoles(UserRole.SEEKER),*/ payment_1.verifyPayment);
routes.post('/transfer/initiate', rateLimiter_1.paymentLimiter, /*allowRoles(UserRole.PROVIDER),*/ payment_1.initiateTransfer);
...
routes.get('/turn-credentials', turn_1.getTurnCredentials);
// Call recordings
routes.post('/call-recordings', callRecording_1.saveCallRecording);
routes.get('/call-recordings', callRecording_1.getCallRecordings);
routes.delete('/call-recordings/:id', callRecording_1.deleteCallRecording);
// Role switching
routes.get('/available-roles', switchRole_1.getAvailableRoles);
routes.put('/switch-role', switchRole_1.switchRole);
